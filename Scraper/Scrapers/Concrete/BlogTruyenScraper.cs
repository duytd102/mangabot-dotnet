...
namespace Scraper.Scrapers.Concrete
{
    public class BlogTruyenScraper : IScraper
    {
        ...
        public override List<Manga> GetMangaList(int pageIndex)
        {
        ...
        public override List<Chapter> GetChapterList(string mangaUrl)
        {
        ...
        public override List<Page> GetPageList(string chapterUrl)
        {
            ...
            try
            {
                ...
                foreach (Match blk in pageBlockes)
                {
                    ...
                    page.Name = "Trang " + CommonUtils.GenerateOrdinalString(pageBlockes.Count, index);
                    page.Url = url;
                    page.LocalPath = "";
